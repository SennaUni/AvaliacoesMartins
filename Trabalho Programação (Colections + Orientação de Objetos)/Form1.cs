...
using Trabalho_Programação__Colections___Orientação_de_Objetos_.Communs;
...
namespace Trabalho_Programação__Colections___Orientação_de_Objetos_
{
    public partial class Form1 : Form
    {
        ...
        private void cadastrarProdutosToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            //Listar(listaProdutos);//Se deixar da um erro de 'O índice -1 não tem um valor.'
        }
        ...
        private bool EditarProduto(List<Produto> listaProdutos)
        {
            ...
            else
            {
                ...
                {
                    if (cadastros.Id == Conversao.ConvertInt(tBoxID.Text))
                    {
            ...
            else
            {
                foreach (var cadastros in listaProdutos)
                {
                    if (cadastros.Id == Conversao.ConvertInt(tBoxID.Text))
                    {
                        ...
                        tBoxValor.Text = Conversao.ConverFloatToString(cadastros.Valor);
